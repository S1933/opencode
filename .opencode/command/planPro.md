...
Delegate this request to `@planPro`. Do not write the plan yourself in the current agent.
...
- Hand off to `@planPro` instead of responding directly in the current primary agent.
